...
- Enlace para acceder a la [elección de las imágenes para el contenedor]()
- Enlace para acceder al [Dockerfile]() y a la [documentación del mismo]() junto con las buenas prácticas
- Enlace para acceder a la documentación del [despliegue automático del contenedor a DockerHub y GHCR]()
- Enlace para acceder a la documentación de la subida del contenedor a [GitHub Container Registry]()